<template>
  <div class="dashboard-daily-avg-count">
    <div class="dashboard-daily-avg-count__wrapper">
...
@Component({
  name: 'DashboardDailyAvgCount',
  components: { BarHorizontalChart, ChartToCsv }
})
export default class extends Vue {
  private title: string = '일 평균 수납건수'
