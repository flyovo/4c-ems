<template>
  <div class="dashboard-setting-drug-by-pharmacy">
    <div class="dashboard-setting-drug-by-pharmacy__header">
      <div class="dashboard-setting-drug-by-pharmacy__header__title">{{ title }}</div>
    </div>
    <div class="dashboard-setting-drug-by-pharmacy__wrapper">
...
export default class extends Vue {
  private title: string = '약국별 약처방전 전송건수'
  ...
  private chartItems: IBarChart = {
    ...
    legend: ['전년', '금년'],
    colors: [variables.install, variables.insurance],
...
<style lang="scss">
.dashboard-setting-drug-by-pharmacy {
  margin-bottom: 30px;
  &__header {
    margin-top: 10px;
    margin-bottom: 10px;
