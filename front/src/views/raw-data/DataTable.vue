    ...
    <div class="raw-data-table__body__table">
      <el-table :data="tableData" header-align="center">
        <el-table-column label="row" align="center">
          ...
          <el-table-column prop="창구 코드" label="창구 코드" sortable align="center"></el-table-column>
          ...
          <el-table-column prop="모델명" label="모델명" sortable align="center"></el-table-column>
          <el-table-column prop="환자등록번호" label="환자등록번호" sortable align="center"></el-table-column>
          <el-table-column prop="수납 시간" label="수납 시간" sortable align="center"></el-table-column>
          <el-table-column prop="수납 건수" label="수납 건수" sortable :formatter="getNumFormat" align="center"></el-table-column>
          <el-table-column prop="수납 금액" label="수납 금액" sortable align="center"></el-table-column>
        </el-table-column>
      </el-table>
