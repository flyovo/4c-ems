      ...
      <div class="raw-data-table__body__table">
        <el-table :data="tableData" header-align="center">
          <el-table-column label="row" align="center">
            ...
            <el-table-column prop="처방전전송" label="처방전전송" sortable align="center"></el-table-column>
            <el-table-column prop="폐기여부" label="폐기여부" sortable align="center"></el-table-column>
            <!-- <el-table-column prop="sunab_date" label="날짜" align="center"></el-table-column>
            ...
            <el-table-column prop="sunab_time" label="수납시간" align="center"></el-table-column>
            <el-table-column prop="cnt_sunap" label="수납건수" align="center"></el-table-column>
            <el-table-column prop="amount" label="수납금액" align="center"></el-table-column>
            <el-table-column prop="pharm_name" label="약국" align="center"></el-table-column> -->
          </el-table-column>
        </el-table>
        <div class="raw-data-table__body__paging">
          <el-pagination :page-size="15" layout="prev, pager, next" :total="totalCount" :current-change.sync="currentPage" @current-change="handleCurrentChange" :currentPage="page"></el-pagination>
        </div>
      </div>
    </div>
  </div>
