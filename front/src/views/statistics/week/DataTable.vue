      ...
      <div class="statistics-table__body__table">
        <el-table :data="tableData" header-align="center">
          <el-table-column label="구분" align="center">
            ...
            <el-table-column prop="대수" label="대수" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="월(일수)" align="center">
            <el-table-column prop="월건수" label="건수" align="center"></el-table-column>
            <el-table-column prop="월금액" label="금액" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="화(일수)" align="center">
            <el-table-column prop="화건수" label="건수" align="center"></el-table-column>
            <el-table-column prop="화금액" label="금액" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="수(일수)" align="center">
            <el-table-column prop="수건수" label="건수" align="center"></el-table-column>
            <el-table-column prop="수금액" label="금액" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="목(일수)" align="center">
            <el-table-column prop="목건수" label="건수" align="center"></el-table-column>
            <el-table-column prop="목금액" label="금액" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="금(일수)" align="center">
            <el-table-column prop="금건수" label="건수" align="center"></el-table-column>
            <el-table-column prop="금금액" label="금액" align="center"></el-table-column>
          </el-table-column>
          <el-table-column label="토(일수)" align="center">
            <el-table-column prop="토건수" label="건수" align="center"></el-table-column>
            <el-table-column prop="토금액" label="금액" align="center"></el-table-column>
          </el-table-column>
        </el-table>
